...
\begin{frame}
  \begin{itemize}
    \item Порядка 160M хитов в день на машину класса EX6 на синтетике в баннерных сетях.
    \item Порядка 8K активных пользователей единомоментно на машину класса EX6 в онлайн-играх.
  \end{itemize}
\end{frame}
