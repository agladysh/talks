...
\begin{itemize}
\item \emph{One tree walker per target.} Otherwise make sure that you trusty old cheese grater is still sharp.
\pause
...
\frametitle{Visual Business Logic Editor DSL family: high-level data schema DSL}
...
\frametitle{Visual Business Logic Editor DSL family: low-level data schema DSL}
...
\frametitle{Visual Business Logic Editor DSL family: output targets}
